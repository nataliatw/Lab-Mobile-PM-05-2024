...
public class Celebrity implements Parcelable {
    ...
    public Celebrity(String username, String name, String desc, int fotoProfile, int fotoPostingan) {
    ...
    public Celebrity(String username, String name, String konten, int fotoProfile, Uri selectedImageUri) {
        this.username = username;
        this.name = name;
        this.desc = konten;
        this.fotoProfile = fotoProfile;
