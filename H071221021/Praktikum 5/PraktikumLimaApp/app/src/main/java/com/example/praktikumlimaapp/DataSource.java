...
public class DataSource {
    ...
    private static ArrayList<Celebrity> generateDummyCelebrities() {
        ...
        celebrities.add(new Celebrity("Milephakphum","Mile Phakphum Romsaithong",",,, Vogue Gala Night 2024 ,,,\n" +
                "\n" +
                "Have A GN นะครับ^^", R.drawable.mile2, R.drawable.mile1,false));
        celebrities.add(new Celebrity("Tedsky89","Teddy Indra Wijaya", "Kami mengucapkan selamat beraktifitas dan bekerja bagi rekan-rekan semuanya… jangan lupa makan siang yang banyak biar kuat seperti adek-adek Taruna Akmil \n" +
                "\n" +
                "Happy weekdays everyone…", R.drawable.mayted4, R.drawable.mayted3,false));
        celebrities.add(new Celebrity("Sound_of_Coups","Choi Seungcheol", "우당탕탕 쿡스쿱스", R.drawable.scoups1, R.drawable.scoups2,false));
        celebrities.add(new Celebrity("Johnnyjsuh","NCT Johnny", "méxico fue increíble", R.drawable.johnny2, R.drawable.johnny1,false));
        celebrities.add(new Celebrity("Ppnaravit","Naravit Letratkosum", "let me cook for u", R.drawable.ppnaravit1, R.drawable.ppnaravit2,false));
        celebrities.add(new Celebrity("Phuwintang","Phuwin Tangsakyuen", "smile for 2022 ", R.drawable.phuwintang2, R.drawable.phuwintang1,false));
        celebrities.add(new Celebrity("Ateez_official_","8 Makes 1 Team", "[#인星화그램] 明日会いましょう\n" +
                "\n" +
                "#ATEEZ #에이티즈 #SEONGHWA #성화", R.drawable.ateez3, R.drawable.ateez1,false));
        celebrities.add(new Celebrity("leejen_o_423","NCT Jeno", "페라가모 FW24 쇼 참석하러 밀라노로 갑니다~~\n" +
                "시즈니 밀라노에서 만나요!!\n" +
                "@ferragamo #ferragamofw24 #페라가모",  R.drawable.jeno2, R.drawable.jeno1,false));
        celebrities.add(new Celebrity("seonho__kim","Kim Seonho", "24년 첫 팬미팅 행복했어요 늘 고맙습니다 #BANGKOK", R.drawable.seonho2, R.drawable.seonho1,false));
        celebrities.add(new Celebrity("that_guy_gonsta","Kyung Dohyun", "안녕하세요 경도현입니다!\n" +
                ...
                "우리, 자주 봐요! \n" +
                "\n" +
                "#스튜디오샤 #도도", R.drawable.dohyun1, R.drawable.dohyun2,false));
        return celebrities;
    }
}
